 ...
 * @var \krisates\cropper\UploadLogo $widget
 *
 */
...
<div class="cropper-widget">
    ...
    <?= Html::hiddenInput('height', $widget->height, ['class' => 'height-input']); ?>
     <div class="col-md-4">
		<div class="cropper-buttons">
			...
			<?= Html::submitButton(Yii::t('cropper', 'BTN_SAVE'), ['class' => 'btn btn-primary']) ?>	
	...
	<div class="col-md-8">
		...
		<div class="new-photo-area" style="height: <?= $widget->cropAreaHeight; ?>px; width: <?= $widget->cropAreaWidth; ?>px;height: 100%; width: 100%; position: absolute; top: 0;" title="<?= $widget->label;?>">
